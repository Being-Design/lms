    ...
    public function cron_update_licenses(){
        ...
        foreach( $saved_licenses as $package_id => $license_details ){
            if( !isset( $packages[ $package_id ] ) )
                continue;//only the currently installed packages, to remove clutter in db
            
            $licenses_to_check[] = array( 'license_key' => $license_details['license_key'], 'activation_email' => $license_details['activation_email'] );
        }
