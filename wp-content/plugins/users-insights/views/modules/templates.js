angular.module('usinModuleApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/modules/license.html',
    "<div>\n" +
    "	<a ng-if=\"module.license.allow_free && !module.options.license.free_activated\" class=\"usin-btn usin-try-btn\" >{{strings.freeTrial}}</a>\n" +
    "\n" +
    "\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/modules/module.html',
    ...
    "				<div class=\"usin-license\" ng-if=\"module.license\"></div>	\n" +
    "\n" +
    "			</div>\n" +
    "			\n" +
