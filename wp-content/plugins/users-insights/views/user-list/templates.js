angular.module('usinApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/user-list/export-dialog.html',
    "<md-dialog aria-label=\"{{strings.exportAction}}\">\n" +
    "		<md-toolbar>\n" +
    "			<div class=\"md-toolbar-tools\">\n" +
    "				<h2>{{strings.exportAction}}</h2>\n" +
    "				<span flex></span>\n" +
    "				<md-button class=\"md-icon-button\" ng-click=\"closeExportDialog()\">\n" +
    ...
    "				<p ng-bind-html=\"strings.confirmExport.replace('%s', total.current)\"></p>\n" +
    "			</div>\n" +
    "		</md-dialog-content>\n" +
    "\n" +
    "		<md-dialog-actions layout=\"row\">\n" +
    "			<div class=\"usin-icon-simple-loading\" ng-show=\"isExportLoading\"></div>\n" +
    "			<button class=\"usin-btn\" ng-click=\"closeExportDialog()\">\n" +
    "				{{strings.cancel}}\n" +
    "			</button>\n" +
    "			<button class=\"usin-btn usin-btn-main\" ng-click=\"export()\">\n" +
  ...
  $templateCache.put('views/user-list/filter.html',
    ...
    "		</div>\n" +
    "		\n" +
    "		<div ng-if=\"filter.applied\" class=\"usin-filter-preview usin-btn\">\n" +
  ...
  $templateCache.put('views/user-list/list-options.html',
    ...
    "	<div class=\"usin-bulk-actions usin-float-left\" ng-if=\"listView\"></div>\n" +
    ...
    "		<ul dnd-list=\"fields\">\n" +
    "			<li ng-repeat=\"field in fields | tableFields\" dnd-draggable=\"field\" dnd-moved=\"reorder($index)\" dnd-disable-if=\"field.disableHide\">\n" +
    "				<dnd-nodrag>\n" +
    "					<span>\n" +
  ...
  $templateCache.put('views/user-list/main.html',
    "<div>\n" +
    "	<div usin-filter fields=\"fields\" filters=\"filters\" loading=\"loading\" broadcast-change=\"applyFilters()\"></div>\n" +
    "</div>\n" +
    "\n" +
    "\n" +
