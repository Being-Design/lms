  ...
  <form name="pm_user_settings" id="pm_user_settings" method="post">
    ...
    <div class="content">
      ...
      <div class="uimsubheader">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Paypal Payment Processor','profile-grid' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Turn on the payment system(s) you want to use for accepting payments. Make sure you configure them right.','profile-grid');?></div>
      </div>
