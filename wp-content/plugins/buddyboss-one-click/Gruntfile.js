...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        checktextdomain: {
            options: {
                text_domain: 'buddyboss-one-click', //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'buddyboss-one-click.pot', // Name of the POT file.
    ...
    // register task
    grunt.registerTask( 'default', [ 'checktextdomain', 'makepot', 'potomo' ] );
};