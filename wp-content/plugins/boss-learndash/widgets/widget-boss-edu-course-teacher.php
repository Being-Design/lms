	...
	protected function load_component ( $instance ) {
        ...
        <footer>          
            ...
            if ( ( is_singular( array('sfwd-courses', 'sfwd-lessons', 'sfwd-topic') ) ) ) {
                ...
                $html = '<p class="bp-group-discussion"><a class="btn inverse" href="'. trailingslashit(home_url()).trailingslashit($bp->pages->groups->slug).$group_data .'">'. sprintf( __('%s Group','boss-learndash'), LearnDash_Custom_Label::get_label( 'course' ) ) .'</a></p>';
