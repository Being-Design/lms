...
<div class="wrap wpProQuiz_questionOverall">
	...
	<p>
		...
		<a class="button-secondary" href="#" id="wpProQuiz_questionCopy"><?php echo sprintf( _x('Copy questions from another %s', 'Copy questions from another Quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?></a>
		<?php } ?>
	...
	<div class="wpProQuiz_questionCopy">
		<form action="admin.php?page=ldAdvQuiz&module=question&quiz_id=<?php echo $this->quiz->getId(); ?>&action=copy_question" method="POST">
			<h2 style="margin-top: 0;"><?php echo sprintf( _x('Copy questions from another %s', 'Copy questions from another Quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ); ?></h2>
			<p><?php echo sprintf( _x('Here you can copy questions from another %s into this %s. (Multiple selection enabled)', 'placeholders: quiz, quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></p>
