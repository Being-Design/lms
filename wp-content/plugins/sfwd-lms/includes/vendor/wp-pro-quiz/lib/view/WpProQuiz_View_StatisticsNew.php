...
tr:hover .wpProQuiz_actions {
	...
	<div class="wrap wpProQuiz_statisticsNew">
		...
		<h1><?php echo sprintf( _x('%s: %s - Statistics', 'placeholders: Quiz, Quiz Name/Title', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ), $this->quiz->getName()); ?></h1>
		<br>		
				...
				<div class="postbox">
					...
					<div class="inside">
						<ul>
							<li>
								<label>
									<?php echo sprintf( _x('Show only users, who solved the %s:', 'Show only users, who solved the quiz:', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' )); ?>
