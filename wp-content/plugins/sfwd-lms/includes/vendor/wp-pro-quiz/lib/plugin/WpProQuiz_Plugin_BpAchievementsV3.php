...
class WpProQuiz_Plugin_BpAchievementsV3 extends DPA_Extension {
	...
	public function __construct() {
		$this->actions = array(
			'wp_pro_quiz_completed_quiz' => sprintf( _x('The user completed a %s.', 'The user completed a quiz.', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ),
			'wp_pro_quiz_completed_quiz_100_percent' => sprintf( _x('The user completed a %s with 100 percent.', 'The user completed a quiz with 100 percent.', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' )),
		);
		...
		$this->description     = sprintf( _x('A powerful and beautiful %s plugin for WordPress.', 'A powerful and beautiful quiz plugin for WordPress.', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) );
		$this->id              = 'wp-pro-quiz';
