...
//			wp_enqueue_style( 
//				'learndash-admin-settings-page-style', 
...
//				LEARNDASH_VERSION 
//			);
//			$learndash_assets_loaded['styles']['learndash-admin-settings-page-style'] = __FUNCTION__;
...
//				true 
//			);
//			$learndash_assets_loaded['scripts']['learndash-admin-settings-page-script'] = __FUNCTION__;
		...
		function show_settings_page() {
			if ( defined( 'LEARNDASH_SETTINGS_SECTION_TYPE' ) && ( LEARNDASH_SETTINGS_SECTION_TYPE == 'metabox' ) ) {
				...
				<div class="wrap learndash-settings-page-wrap">
					...
					<form id="learndash-settings-page-form" method="post" action="options.php">
