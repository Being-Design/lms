...
if ( ( class_exists( 'LearnDash_Settings_Page' ) ) && ( !class_exists( 'LearnDash_Settings_Page_Courses_Shortcodes' ) ) ) {
	class LearnDash_Settings_Page_Courses_Shortcodes extends LearnDash_Settings_Page {
		...
		function __construct() {
			...
			$this->settings_page_title 		= 	sprintf( _x( '%s Shortcodes', 'Course Shortcodes Label', 'learndash' ), LearnDash_Custom_Label::get_label( 'course' ) );
				...
				<div class='sfwd_options_wrapper sfwd_settings_left'>
					<div class='postbox ' id='sfwd-course_metabox'>
						...
						echo '<b>' . __( 'Shortcode Options', 'learndash' ) . '</b>
							...
							<p>' . sprintf( _x( 'Displays user\'s enrolled %s, %s progress, %s scores, and achieved certificates. This shortcode can take following parameters:', 'placeholder: courses, course, quiz', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'course' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ) . '</p>
							<ul>
							...
							<p>' . __( 'See <a target="_blank" href="https://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters">the full list of available orderby options here.</a>', 'learndash' ) . '</p><br/>
							
							<p class="ld-shortcode-header">[ld_course_list]</p>
							<p>' . sprintf( _x( 'This shortcode shows list of %s. You can use this shortcode on any page if you dont want to use the default <code>/%s</code> page. This shortcode can take following parameters:', 'placeholders: courses, courses (URL slug)', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), 
LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Section_Permalinks', 'courses' ) ) . '</p>
							...
							if ( LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Courses_Taxonomies', 'wp_post_category' ) == 'yes') {
								echo '<li><b>cat</b>: ' . sprintf( _x( 'shows %s with mentioned category id. Example: <b>[ld_course_list cat="10"]</b> shows %s having category with category id 10.', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'courses' ) ) . '</li>
								...
								echo '<li><b>categoryselector</b>: ' . __( 'shows a course category dropdown. Example: <b>[ld_course_list categoryselector="true"]</b>.', 'learndash' ) . '</li>';
							}

							if ( LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Courses_Taxonomies', 'wp_post_tag' ) == 'yes') {
								echo '<li><b>tag</b>: ' . sprintf( _x( 'shows %s with mentioned tag. Example: <b>[ld_course_list tag="math"]</b> shows %s having tag math.', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'courses' ) ) . '</li>
							...
							if ( LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Courses_Taxonomies', 'ld_course_category' ) == 'yes') {
								echo '<li><b>course_cat</b>: ' . sprintf( _x( 'shows %s with mentioned course category id. Example: <b>[ld_course_list course_cat="10"]</b> shows %s having course category with category id 10.', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'courses' ) ) . '</li>

								<li><b>course_category_name</b>: ' . sprintf( _x( 'shows %s with mentioned course category slug. Example: <b>[ld_course_list course_category_name="math"]</b> shows %s having course category slug math.', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'courses' ) ) . '</li>';

								echo '<li><b>course_categoryselector</b>: ' . __( 'shows a category dropdown. Example: <b>[ld_course_list course_categoryselector="true"]</b>.', 'learndash' ) . '</li>';
							}

							if ( LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Courses_Taxonomies', 'ld_course_tag' ) == 'yes') {
								echo '<li><b>course_tag</b>: ' . sprintf( _x( 'shows %s with mentioned course tag. Example: <b>[ld_course_list course_tag="math"]</b> shows %s having course tag math.', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'courses' ) ) . '</li>
							<li><b>course_tag_id</b>: ' . sprintf( _x( 'shows %s with mentioned course_tag_id. Example: <b>[ld_course_list course_tag_id="30"]</b> shows %s having course tag with tag_id 30.', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'courses' ) ) . '</li>';
							}
							echo '</ul></p>
							<p>' . __( 'See the full list of <a target="_blank" href="https://codex.wordpress.org/Class_Reference/WP_Query#Category_Parameters">Category</a> and <a target="_blank" href="https://codex.wordpress.org/Class_Reference/WP_Query#Tag_Parameters">Tag</a> filtering options.', 'learndash' ) . '</p><br />
							...
							<p>' . sprintf( _x( 'This shortcode shows list of %s. You can use this shortcode on any page. This shortcode can take following parameters: num, order, orderby. See [ld_course_list] above details on using the shortcode parameters.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ) . '</p><br>
							...
							<p>' . sprintf( _x( 'This shortcode shows the content if the user is not enrolled in the %s. The shortcode can be used on <strong>any</strong> page or widget area. This shortcode can take following parameters:', 'placeholders: course', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</p>
							<ul>
							<li><b>course_id</b>: ' . sprintf( _x( 'Optional. Show content if the student does not have access to a specific %s. Example: <b>[visitor course_id="10"]insert any content[/visitor]</b>', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</li>
							</ul><br>
							
		                    <p class="ld-shortcode-header">[student]</p>
							<p>' . sprintf( _x( 'This shortcode shows the content if the user is enrolled in the %s. The shortcode can be used on <strong>any</strong> page or widget area. This shortcode can take following parameters:', 'placeholders: course', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</p>
							<ul>
							<li><b>course_id</b>: ' . sprintf( _x( 'Optional. Show content if the student has access to a specific course. Example: <b>[student course_id="10"]insert any content[/student]</b>', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</li>
							</ul><br>
							
							<p class="ld-shortcode-header">[course_complete]</p><p>' . sprintf( _x( 'This shortcode shows the content if the user has completed the %s. The shortcode can be used on <strong>any</strong> page or widget area. This shortcode can take following parameters:', 'placeholders: course', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</p>
							<ul>
							<li><b>course_id</b>: ' . sprintf( _x( 'Optional. Show content if the student has access to a specific %s. Example: <b>[course_complete course_id="10"]insert any content[/course_complete]</b>', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</li>
							<li><b>user_id</b>: ' . __( 'Optional. If not provided will use current logged in user. Example: <b>[course_complete course_id="10" user_id="456"]insert any content[/course_complete]</b>' ) . '</li>
							</ul><br />

							
							<p class="ld-shortcode-header">[course_inprogress]</p>
							<p>' . sprintf( _x( 'This shortcode shows the content if the user has started but not completed the %s. The shortcode can be used on <strong>any</strong> page or widget area. This shortcode can take following parameters:', 'placeholders: course', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</p>
							<ul>
							<li><b>course_id</b>: ' . sprintf( _x( 'Optional. Show content if the student has access to a specific %s. Example: <b>[course_inprogress course_id="10"]insert any content[/course_inprogress]</b>', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</li>
							...
							<p>' . sprintf( _x( 'This shortcode shows the content if the user has access to the %s but not yet started. The shortcode can be used on <strong>any</strong> page or widget area. This shortcode can take following parameters:', 'placeholders: course', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</p>
							<ul>
							<li><b>course_id</b>: ' . sprintf( _x( 'Optional. Show content if the student has access to a specific %s. Example: <b>[course_notstarted course_id="10"]insert any content[/course_notstarted]</b>', 'placeholders: courses, courses', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</li>
							<li><b>user_id</b>: ' . __( 'Optional. If not provided will use current logged in user. Example: <b>[course_notstarted course_id="10" user_id="456"]insert any content[/course_notstarted]</b>' ) . '</li>
							</ul><br />

							<p class="ld-shortcode-header">[ld_course_info]</p>
							<p>' . sprintf( _x( 'This shortcode shows the %s for the user. This shortcode can take following parameters: user_id if not provided will assume current user. Example usage: <strong>[ld_course_info user_id="123"]</strong> will show the %s for the user 123', 'placeholders: course, course', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'courses' ), LearnDash_Custom_Label::label_to_lower( 'courses' ) ) . '</p><br />

							<p class="ld-shortcode-header">[ld_user_course_points]</p>
							<p>' . sprintf( _x( 'This shortcode shows the earned %s points for the user. This shortcode can take following parameters: user_id if not provided will assume current user. Example usage: <strong>[ld_user_course_points]</strong></strong>', 'placeholders: course, course', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'course' ) ) . '</p><br />

							<p class="ld-shortcode-header">[user_groups]</p>
							<p>' . __( 'This shortcode displays the list of groups users are assigned to as users or leaders.', 'learndash' ) . '</p><br/ >
