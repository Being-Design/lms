...
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) && ( !class_exists( 'LearnDash_Settings_Lessons_CPT' ) ) ) {
	class LearnDash_Settings_Lessons_CPT extends LearnDash_Settings_Section {
		...
		function __construct() {
			...
			$this->settings_section_label			=	sprintf( _x( '%s Custom Post Type Options', 'placeholder: Lesson', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson') );
		
			// Used to show the section description above the fields. Can be empty
			$this->settings_section_description		=	sprintf( _x( '<p>Control the LearnDash %s Custom Post Type Options.</p>', 'placeholder: Lessons', 'learndash' ), LearnDash_Custom_Label::get_label( 'lessons') );
