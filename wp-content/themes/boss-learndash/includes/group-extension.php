	...
	class GType_Course_Group extends BP_Group_Extension {
		...
		function display( $group_id = null ) {
			...
			if ( ! empty( $lessons ) ) {
				...
				<p class="no-lesson-msg"><strong><?php printf( __('This %s has no %s added yet','boss-learndash'), LearnDash_Custom_Label::get_label( 'course' ), LearnDash_Custom_Label::get_label( 'lesson' ) ); ?></strong></p><?php
			}
		}
