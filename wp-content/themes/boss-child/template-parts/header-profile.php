			...
			if ( buddyboss_is_bp_active() && bp_is_active( 'notifications' ) ):
				...
				if ( function_exists( 'buddyboss_notification_bp_members_shortcode_bar_notifications_menu' ) ) {
					...
					<div class="header-notifications all-notifications">
						<a class="notification-link fa fa-bell" href="<?php echo bp_core_get_user_domain( get_current_user_id() ); ?>notifications">
							<span class="sr-only"><?php _e('Notifications'); ?></span>
						</a>


						<?php if( !empty($notifications) && !empty($link) ) :?>
						<div class="pop">
