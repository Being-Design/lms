...
<?php $current_user_roles = wp_get_current_user()->roles; ?>
...
<div id="item-header-cover">

    <div class="member-header-wrapper">

        <div class="member-header-container center-margin">

            <div class="member-header-userinfo">
                ...
                <div id="item-header-content">
                    <div class="basic">
						...
						<?php if ( ! empty( $profile_social_media_links_switch ) ): ?>
                    <!-- Socials -->
					...
					*/ ?>
                    ...
                    <div id="item-buttons" class="profile">
                        ...
                        <?php if(
                        	...
                        	in_array('group_leader', $current_user_roles)
                        	) : ?>
                        <div id="main-button" class="<?php
						if ( !empty( $action_output ) ) {
							echo 'primary-btn';
						...
						?>">
							...
							<div id="view-journal-link" class="generic-button">
								<a href="blog" class="view-journal">
									<?php _e('View Journal') ?>
								</a>
							</div>
